...
<head>
    ...
    <title>Unity Web Player | VoltiGO</title>
    ...
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            u.initPlugin(jQuery("#unityPlayer")[0], "Untitled.unity3d");
            ...
            setTexture('http://localhost:8000/uploads/badge2.png');
...
<p class="header"><span>Unity Web Player | </span>VoltiGO</p>
<div class="content">
    <div id="unityPlayer">
        <div class="missing">
